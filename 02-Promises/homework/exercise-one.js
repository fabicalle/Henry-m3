...
function problemA () {
  ...
  // promise version
  // ???
promisifiedReadFile('poem-one/stanza-01.txt').then((result)=>blue(result));
}
...
function problemB () {
 ...
 // });
  ...
  // promise version
  // ???
 promisifiedReadFile('poem-one/stanza-02.txt').then((result)=>blue(result));
 promisifiedReadFile('poem-one/stanza-03.txt').then((result)=>blue(result));
}
...
function problemC () {
 ...
 // });
  ...
  // ???
Promise.all([promisifiedReadFile('poem-one/stanza-02.txt'), promisifiedReadFile('poem-one/stanza-03.txt'),])
.then((stanzas)=>{
stanzas.forEach((stanzas)=>blue(stanzas));
console.log('done');
})
}
...
function problemD () {
 ...
 // });
  ...
  // promise version
  // ???
promisifiedReadFile('poem-one/wrong-file-name.txt').then((stanza)=>{
  blue(stanza);
},
(err)=>{
